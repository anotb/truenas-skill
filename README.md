...
An AI agent skill for managing TrueNAS SCALE via its API. Check pool health, manage datasets and snapshots, monitor alerts, control apps, and orchestrate Dockge container stacks — all through natural language.
...
- Node.js 18+ (for Dockge scripts only)
...
| Snapshots | Create manual snapshots, check schedules |
